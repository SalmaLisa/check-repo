				...
				<Panel>
					...
					<PanelBody>
						<ReusableTabNavs
							...
							navprops={
								(currentUser?.role?.name === 'Clinic' || currentUser?.role?.name === 'Solo')?
								[
						...
						<TabContent activeTab={this.state.activeTab}>
							...
							<ReusableTab id={(currentUser?.role?.name === 'Clinic' || currentUser?.role?.name === 'Solo')?3:4}>
									<div className="membership">
										<div className="_main">
							...
							<ReusableTab id={(currentUser?.role?.name === 'Clinic' || currentUser?.role?.name === 'Solo')?4:5}>
							<div className="membership">
									{/* <table className="table table-profile"> */}
										<div className="_main">
											<div className="_row">
							...
							<ReusableTab id={(currentUser?.role?.name === 'Clinic' || currentUser?.role?.name === 'Solo')?5:6}>
